...
import 'package:dnd_app/screens/profile.dart'; // Import the ProfilePage
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
...
class _ScheduleState extends State<Schedule> {
  ...
  void initState() {
    super.initState();
    events = Map<DateTime, List<Event>>.from(widget.events); // Initialize with passed events
    _fetchEventsFromFirestore();
  }
  ...
  void _onTabTapped(int index) {
    ...
    if (index == 1) {
      // Navigate to ProfilePage when "Tempy" is tapped
      Navigator.push(
        context,
        MaterialPageRoute(
