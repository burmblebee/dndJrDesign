...
Future<void> main() async {
  runApp(MaterialApp(home: DMCombatScreen(campaignId: '15',), theme: ThemeData(
    ...
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
      backgroundColor: Color(0xFF25291C),
      selectedItemColor:
      Color.fromARGB(255, 243, 241, 230), // Warm white highlight
      unselectedItemColor:
      Color.fromARGB(255, 159, 158, 154), // Muted grayish tone
    ),
    ...
    cardColor:
    const Color(0xFF464538), // Match primary color for consistency
