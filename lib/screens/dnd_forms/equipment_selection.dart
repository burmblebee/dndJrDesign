...
class EquipmentSelection extends ConsumerStatefulWidget {
  final List<String> initialWeapons;
  const EquipmentSelection({Key? key, this.initialWeapons = const []}) : super(key: key);
...
class _EquipmentSelectionState extends ConsumerState<EquipmentSelection> {
  ...
  // allWeapons remains constant and is not modified.
  ...
  String searchQuery = '';
  late List<String> selectedWeapons;

  @override
  void initState() {
    super.initState();
    // Initialize selectedWeapons from initialWeapons.
    selectedWeapons = List<String>.from(widget.initialWeapons);
  ...
  Widget build(BuildContext context) {
    ...
    // The available list is always the same, filtered by search query.
                  ...
                  ListView(
                    ...
                    children: [
                      ...
                      selectedWeapons.isNotEmpty
                          ? ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final String group = simpleWeapons.contains(weapon)
                                    ? "SimpleWeapons"
                                    : "MartialWeapons";
                                final details = WeaponData.Weapons[group]?[weapon] ?? {
                                  "damage_die": "N/A",
                                  "gold_cost": "N/A",
                                  "damage_type": "N/A",
                                  "properties": ["N/A"],
                                ...
                                return Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    trailing: IconButton(
                                      ...
                                      onPressed: () {
                                        setState(() {
                                          // Remove only one occurrence of this weapon.
                                          selectedWeapons.removeAt(index);
                                        });
                                      },
                                    ),
                                  ),
                          ...
                          : const Center(child: Text('No weapons selected.')),
                      const SizedBox(height: 10),
                      ...
                      filteredWeapons.isNotEmpty
                                ...
                                return Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    trailing: IconButton(
                                      ...
                                      onPressed: () {
                                        setState(() {
                                          // Allow multiple copies by always adding the weapon.
                          ...
                          : const Center(child: Text('No weapons match your search.')),
                    ],
                  ),
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    ref.read(characterProvider.notifier).updateWeapons(selectedWeapons);
                    Navigator.push(
                      context,
                      MaterialPageRoute(
