      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            // Display starting armor (defaulting to "Robes" if empty)
            _buildSummaryTile(context, 'Armor', startingArmor ?? 'Robes'),
            // Display kit/instrument (joined if it’s a list)
...
//         'cantrips': character.cantrips,
//         'spells': character.spells,
//         // Equipment selections now use the unified field name.
//         'startingKit': character.selectedKit,
//         'startingArmor': character.selectedArmor,
//         'selectedEquipment': character.selectedEquipment,
//         'level': 1, // Hard-coded until leveling up functionality is added.
...
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(
//               content: Text('Character data sent to Firestore successfully!')),
//         );
//       } catch (e) {
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(content: Text('Failed to send character data: $e')),
...
//             _buildSummaryTile(context, 'Background', character.background),
//             _buildSummaryTile(
//                 context, 'Alignment', character.traits['alignment'] ?? ''),
//             _buildSummaryTile(
//                 context, 'Faith', character.traits['faith'] ?? ''),
//             _buildSummaryTile(
//                 context, 'Lifestyle', character.traits['lifestyle'] ?? ''),
//             _buildSummaryTile(context, 'Hair', character.traits['hair'] ?? ''),
//             _buildSummaryTile(context, 'Eyes', character.traits['eyes'] ?? ''),
//             _buildSummaryTile(context, 'Skin', character.traits['skin'] ?? ''),
//             _buildSummaryTile(
//                 context, 'Height', character.traits['height'] ?? ''),
//             _buildSummaryTile(
//                 context, 'Weight', character.traits['weight'] ?? ''),
//             _buildSummaryTile(context, 'Age', character.traits['age'] ?? ''),
//             _buildSummaryTile(
//                 context, 'Gender', character.traits['gender'] ?? ''),
//             _buildSummaryTile(context, 'Personality Traits',
//                 character.traits['personalityTraits'] ?? ''),
//             _buildSummaryTile(
//                 context, 'Ideals', character.traits['ideals'] ?? ''),
//             _buildSummaryTile(
//                 context, 'Bonds', character.traits['bonds'] ?? ''),
//             _buildSummaryTile(
//                 context, 'Flaws', character.traits['flaws'] ?? ''),
//             _buildSummaryTile(context, 'Organizations',
//                 character.traits['organization'] ?? ''),
//             _buildSummaryTile(
//                 context, 'Allies', character.traits['allies'] ?? ''),
//             _buildSummaryTile(
//                 context, 'Enemies', character.traits['enemies'] ?? ''),
//             _buildSummaryTile(
//                 context, 'Backstory', character.traits['backstory'] ?? ''),
//             _buildSummaryTile(
//                 context, 'Other', character.traits['other'] ?? ''),
//             const SizedBox(height: 20),
//             Text(
//               'Stats',
//               style: Theme.of(context).textTheme.headlineMedium,
//             ),
//             const SizedBox(height: 10),
//             _buildSummaryTile(context, 'Strength',
//                 character.abilityScores['Strength'].toString()),
//             _buildSummaryTile(context, 'Dexterity',
//                 character.abilityScores['Dexterity'].toString()),
//             _buildSummaryTile(context, 'Constitution',
//                 character.abilityScores['Constitution'].toString()),
//             _buildSummaryTile(context, 'Intelligence',
//                 character.abilityScores['Intelligence'].toString()),
//             _buildSummaryTile(context, 'Wisdom',
//                 character.abilityScores['Wisdom'].toString()),
//             _buildSummaryTile(context, 'Charisma',
//                 character.abilityScores['Charisma'].toString()),
//             const SizedBox(height: 20),
//             Text(
//               'Weapons',
//               style: Theme.of(context).textTheme.headlineMedium,
